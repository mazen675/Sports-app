...
class OnBoardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        skipButton.setTitle("skip_btn".localized, for: .normal)
    ...
    @IBAction func didSkip(_ sender: Any) {
            ...
            let mainAppVC = storyboard.instantiateViewController(withIdentifier: "TabBarController") as! UITabBarController
            UserDefaults.standard.set(true, forKey: "hasSeenOnboarding")
            
            if let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene,
               let window = windowScene.windows.first {
               
                window.rootViewController = UINavigationController(rootViewController: mainAppVC)
